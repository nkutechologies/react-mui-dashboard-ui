...
export default function ChatHeaderDetail({ participants }: Props) {
  ...
  return (
    <RootStyle>
      ...
      <Box sx={{ flexGrow: 1 }} />
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '19em' }}>
        <Button
          style={{ backgroundColor: '#E0E2E8', boxShadow: 'none', color: 'black' }}
          variant="contained"
          startIcon={<EditIcon />}
        >
          Edit Profile
        ...
        <Button
          style={{ backgroundColor: '#5C60CD', boxShadow: 'none', color: 'white' }}
          variant="contained"
